        ...
        public void exportDataToWord(DataGridView DGV, string filename)
        {
            if (DGV.Rows.Count != 0)
            {
                ...
                for (int r = 1; r <= RowCount; r++)
                {
                    ...
                    System.Drawing.Image finalPic = new Bitmap(sparePicture, new Size(100, 100));
                    System.Windows.Clipboard.SetDataObject(finalPic);*/
