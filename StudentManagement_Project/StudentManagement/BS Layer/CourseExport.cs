    ...
    class CourseExport
    {
        ...
        public void exportDataToExcel(System.Data.DataTable dt, string sheetName, string title, string filename)
        {
...

            {
                ...
                for (int c = 0; c < dt.Columns.Count; c++)
                {
                    ...
                    if (c == 7)
                    {
                        byte[] imgbyte = (byte[])dr[c];
                        MemoryStream ms = new MemoryStream(imgbyte);
                        System.Drawing.Image sparePicture = System.Drawing.Image.FromStream(ms);
                        Bitmap finalPic = new Bitmap(sparePicture, new Size(90, 90));
        ...
        public void exportDataToWord(DataGridView DGV, string filename)
        {
            if (DGV.Rows.Count != 0)
            {
                ...
                tittle.Range.Text = "Course List";
                tittle.Range.Font.Size = 26;
                tittle.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;
                tittle.Range.Bold = 1;
        ...
        public void exportStudentListToWord(DataGridView DGV, string filename, string coursenameok)
        {
            if (DGV.Rows.Count != 0)
            {
                Word.Application word = new Word.Application();//make a new word object
                ...
                Word.Paragraph tittle;
                tittle = doc.Paragraphs.Add();
                tittle.Range.Text = "Student List By Course";
                tittle.Range.Font.Size = 26;
                tittle.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;
                tittle.Range.Bold = 1;
                tittle.Range.Font.Name = "Comic Sans MS";*/
